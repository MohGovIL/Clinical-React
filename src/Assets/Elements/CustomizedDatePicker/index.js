...
const CustomizedDatePicker = ({
  ...
  if (languageCode === 'he') {
    Moment.updateLocale('he', {
      weekdays: 'יום ראשון_ יום שני_ יום שלישי_ יום רביעי_ יום חמישי_ יום שישי_שבת'.split(
        '_',
      ),
  ...
  const ChevronSecond =
    languageDirection === 'rtl' ? ChevronLeft : ChevronRight;
  ...
  if (
    'CustomizedProps' in props &&
    typeof props.CustomizedProps !== 'undefined'
  ) {
    showPrevArrow =
      typeof props.CustomizedProps.showPrevArrow !== 'undefined' &&
      props.CustomizedProps.showPrevArrow
        ? true
        : false;
    showNextArrow =
      typeof props.CustomizedProps.showNextArrow !== 'undefined' &&
      props.CustomizedProps.showNextArrow
        ? true
        : false;
    DatePickerType = props.CustomizedProps.keyBoardInput
      ? StyledKeyboardDatePicker
      : StyledDatePicker;
...
export default connect(mapStateToProps, { setFilterDateAction })(
