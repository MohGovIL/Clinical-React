...
const appointmentsWithPatientsBasePath = summary => `${fhirBasePath}/Appointment?status:not=arrived&_sort=priority&_sort=date&_sort=service-type${summary ? '&_summary=count' : '&_include=Appointment:patient'}`;
